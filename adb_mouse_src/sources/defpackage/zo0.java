...
public final class zo0 {
    ...
    /* JADX WARN: Type inference failed for: r0v5, types: [java.lang.Object, ds] */
    public zo0() {
    ...
    public final void a(float f) {
        if (f >= 0.0f) {
            ...
            c.k("Damping ratio must be non-negative");
        }
    }
    ...
    public final void b(float f) {
        if (f > 0.0f) {
            ...
            c.k("Spring stiffness constant must be positive.");
        }
    }

    public final ds c(double d, double d2, long j) {
        double sin;
        double cos;
        if (!this.c) {
            if (this.i != Double.MAX_VALUE) {
                ...
                c.o("Error: Final position of the spring must be set before the animation starts");
                return null;
            }
        }
        double d7 = j / 1000.0d;
    ...
    /* JADX WARN: Type inference failed for: r0v4, types: [java.lang.Object, ds] */
    public zo0(float f) {
        this.a = Math.sqrt(1500.0d);
        this.b = 0.5d;
        this.c = false;
