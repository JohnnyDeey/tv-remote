...
public final class bf {
    ...
    public bf(float f, float f2, float f3, float f4, float f5, float f6) {
        this.a = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
    ...
    public static bf a(int i) {
        float f;
        sz0 sz0Var = sz0.k;
        float I = wv0.I(Color.red(i));
        float I2 = wv0.I(Color.green(i));
        float I3 = wv0.I(Color.blue(i));
        float[][] fArr = wv0.f;
        float[] fArr2 = fArr[0];
        float f2 = (fArr2[2] * I3) + (fArr2[1] * I2) + (fArr2[0] * I);
        float[] fArr3 = fArr[1];
        float f3 = (fArr3[2] * I3) + (fArr3[1] * I2) + (fArr3[0] * I);
        float[] fArr4 = fArr[2];
        float f4 = (I3 * fArr4[2]) + (I2 * fArr4[1]) + (I * fArr4[0]);
        float[][] fArr5 = wv0.c;
        float[] fArr6 = fArr5[0];
        ...
        float pow4 = ((float) Math.pow((f19 * sz0Var.b) / f10, sz0Var.j * f9)) * 100.0f;
        ...
        float pow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, sz0Var.f), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((f * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * sz0Var.e) * sz0Var.c) * ((float) Math.sqrt((f16 * f16) + (f15 * f15)))) / (f18 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow4 / 100.0d));
        Math.sqrt((r0 * f9) / f21);
        float f22 = (1.7f * pow4) / ((0.007f * pow4) + 1.0f);
        float log = ((float) Math.log((f8 * pow5 * 0.0228f) + 1.0f)) * 43.85965f;
        double d2 = f20;
        return new bf(atan2, pow5, pow4, f22, log * ((float) Math.cos(d2)), log * ((float) Math.sin(d2)));
    }

    public static bf b(float f, float f2, float f3) {
        sz0 sz0Var = sz0.k;
        float f4 = sz0Var.d;
        Math.sqrt(f / 100.0d);
        float f5 = sz0Var.a + 4.0f;
        float f6 = sz0Var.i * f2;
        Math.sqrt(((f2 / ((float) Math.sqrt(r1))) * sz0Var.d) / f5);
        float f7 = (1.7f * f) / ((0.007f * f) + 1.0f);
        float log = ((float) Math.log((f6 * 0.0228d) + 1.0d)) * 43.85965f;
        double d = (3.1415927f * f3) / 180.0f;
        return new bf(f3, f2, f, f7, log * ((float) Math.cos(d)), log * ((float) Math.sin(d)));
    }

    public final int c(sz0 sz0Var) {
        float f;
        float f2 = this.b;
        double d = f2;
        float f3 = this.c;
        if (d != 0.0d) {
            ...
            if (d2 != 0.0d) {
                ...
                float pow2 = sz0Var.a * ((float) Math.pow(f3 / 100.0d, (1.0d / sz0Var.d) / sz0Var.j));
                float f6 = cos * 3846.1538f * sz0Var.e * sz0Var.c;
                float f7 = pow2 / sz0Var.b;
                ...
                float[] fArr5 = fArr2[2];
                return oi.a(f19, f20, (f18 * fArr5[2]) + (f17 * fArr5[1]) + (f16 * fArr5[0]));
            }
        }
        f = 0.0f;
        float f42 = sz0Var.f;
        ...
        float pow22 = sz0Var.a * ((float) Math.pow(f3 / 100.0d, (1.0d / sz0Var.d) / sz0Var.j));
        float f62 = cos3 * 3846.1538f * sz0Var.e * sz0Var.c;
        float f72 = pow22 / sz0Var.b;
        ...
        return oi.a(f192, f202, (f182 * fArr52[2]) + (f172 * fArr52[1]) + (f162 * fArr52[0]));
    }
}
