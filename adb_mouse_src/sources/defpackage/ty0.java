...
public final class ty0 {
    public static final eh0 v = new eh0(1);
    public int a;
    public final int b;
    public float[] d;
    public float[] e;
    ...
    public int c = -1;
    public final l9 u = new l9(16, this);

    public ty0(Context context, CoordinatorLayout coordinatorLayout, oi0 oi0Var) {
        if (oi0Var != null) {
    ...
    */
    public final boolean c(android.view.View r4, float r5, float r6) {
        ...
        L41:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ty0.c(android.view.View, float, float):boolean");
    }
    ...
    public final boolean h(int i, int i2, int i3, int i4) {
        ...
        float f6 = f3 / f4;
        oi0 oi0Var = this.q;
        overScroller.startScroll(left, top, i5, i6, (int) ((e(i6, i4, oi0Var.l()) * f6) + (e(i5, i3, oi0Var.k(view)) * f5)));
        n(2);
        return true;
    }
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                if (this.a == 1) {
                    ...
                    if (i7 != 0) {
                        left = oi0Var.a(this.r, left);
                        WeakHashMap weakHashMap = ry0.a;
                        this.r.offsetLeftAndRight(left - left2);
                    }
                    if (i8 != 0) {
                        top = oi0Var.b(this.r, top);
                        WeakHashMap weakHashMap2 = ry0.a;
                        this.r.offsetTopAndBottom(top - top2);
                    }
                    if (i7 != 0 || i8 != 0) {
                        oi0Var.r(this.r, left, top);
                    }
                    m(motionEvent);
                    return;
                }
    ...
    public final boolean o(int i, int i2) {
        ...
        c.o("Cannot settleCapturedViewAt outside of a call to Callback#onViewReleased");
        return false;
    }
    ...
    */
    public final boolean p(android.view.MotionEvent r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ty0.p(android.view.MotionEvent):boolean");
    }
