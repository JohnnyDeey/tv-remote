...
public final class sz0 {
    ...
    static {
        float[] fArr = wv0.e;
        float g0 = (float) ((wv0.g0() * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = wv0.c;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        ...
        float exp = (1.0f - (((float) Math.exp(((-g0) - 42.0f) / 92.0f)) * 0.2777778f)) * 1.0f;
        double d = exp;
        if (d > 1.0d) {
            exp = 1.0f;
        } else if (d < 0.0d) {
        ...
        float f9 = 1.0f / ((5.0f * g0) + 1.0f);
        float f10 = f9 * f9 * f9 * f9;
        float f11 = 1.0f - f10;
        float cbrt = (0.1f * f11 * f11 * ((float) Math.cbrt(g0 * 5.0d))) + (f10 * g0);
        float g02 = wv0.g0() / fArr[1];
        double d2 = g02;
        ...
        k = new sz0(g02, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * pow, pow, pow, 0.69f, 1.0f, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), sqrt);
    }

    public sz0(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
