...
public final class da0 extends d6 implements MenuItem {
    public final pq0 c;
    public Method d;

    public da0(Context context, pq0 pq0Var) {
        super(context);
        if (pq0Var != null) {
            this.c = pq0Var;
        } else {
    ...
    public final View getActionView() {
        ...
        if (actionView instanceof ba0) {
            return (View) ((ba0) actionView).c;
        }
        return actionView;
    }
    ...
    public final MenuItem setActionProvider(ActionProvider actionProvider) {
        aa0 aa0Var = new aa0(this, actionProvider);
    ...
    public final MenuItem setActionView(int i) {
        pq0 pq0Var = this.c;
        pq0Var.setActionView(i);
        View actionView = pq0Var.getActionView();
        if (actionView instanceof CollapsibleActionView) {
            pq0Var.setActionView(new ba0(actionView));
        }
        return this;
    }
    ...
    public final MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        ...
        if (onActionExpandListener != null) {
            ca0Var = new ca0(this, onActionExpandListener);
        } else {
            ca0Var = null;
        }
        this.c.setOnActionExpandListener(ca0Var);
        return this;
    }
    ...
    public final MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onMenuItemClickListener) {
        ...
        if (onMenuItemClickListener != null) {
            mq0Var = new mq0(this, onMenuItemClickListener);
        } else {
            mq0Var = null;
        }
        this.c.setOnMenuItemClickListener(mq0Var);
        return this;
    }
