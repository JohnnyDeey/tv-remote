...
public final class vd0 {
    ...
    public static void b(vd0[] vd0VarArr, Path path) {
        int i;
        float[] fArr;
        int i2;
        vd0 vd0Var;
        ...
        char c2 = 'm';
        while (i5 < length) {
            vd0 vd0Var3 = vd0VarArr2[i5];
            char c3 = vd0Var3.a;
            float[] fArr3 = vd0Var3.b;
            float f11 = fArr2[i4];
            float f12 = fArr2[1];
            float f13 = fArr2[2];
            float f14 = fArr2[3];
            ...
            c2 = vd0Var3.a;
            i5++;
            vd0VarArr2 = vd0VarArr;
            path2 = path;
            i4 = i6;
        }
    }

    public vd0(char c, float[] fArr) {
        this.a = c;
        this.b = fArr;
    }
}
