...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        setBackground(new e2(this));
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ng0.a);
        boolean z = false;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        ...
        if (drawable != drawable2 || z) {
            if (drawable != this.g || !this.j) {
                if ((drawable == this.h && z) || super.verifyDrawable(drawable)) {
                    return true;
                }
                return false;
            }
    ...
    public void setTabContainer(gm0 gm0Var) {
    }
}
